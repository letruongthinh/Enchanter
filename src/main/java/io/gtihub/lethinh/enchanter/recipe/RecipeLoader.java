...
import io.gtihub.lethinh.enchanter.Enchanter;
...
public class RecipeLoader {
    ...
    public static void init() {
        ...
        {
            ShapedRecipe recipe = new ShapedRecipe(new NamespacedKey(plugin, "enchanter"), plugin.enchanter);
        ...
        {
            ShapedRecipe recipe = new ShapedRecipe(new NamespacedKey(plugin, "enchant_pedestal"), plugin.enchantPedestal);
